...
--
-- Host: localhost
-- Generation Time: 19-Mar-2019 às 17:22
...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL,
  `cpf_ou_cnpf` varchar(255) DEFAULT NULL,
...
INSERT INTO `cliente` (`id`, `cpf_ou_cnpf`, `email`, `nome`, `tipo`) VALUES
(1, '36378912377', 'maria@gmail.com', 'Mary', 1);
...
(1, 'Jardim', '38220834', 'Apto 101', 'Rua Flores', '300', 1, 1),
(2, 'Centro', '3877012', 'Sala 200', 'Rua Matos', '102', 2, 1);
...
(1, '2017-09-30 10:39:00', 1, 1),
(2, '2017-10-10 10:39:00', 1, 2);
